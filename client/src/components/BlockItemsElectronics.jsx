...
const BlockItemsElectronics = ({ categoryTitle, bannerImage, itemsData, bannerBg }) => {
  return (
    ...
    <section className="w-[1180px] h-[257px] mx-auto mt-[20px] bg-[#FFFFFF] border border-[#E0E0E0] rounded-[6px] flex overflow-hidden shadow-sm">
      ...
      {/* left-aside (group) */}
      <div 
        style={{ backgroundColor: bannerBg || 'transparent' }} 
        className="w-[280px] h-full relative p-[20px]"
      >
        {bannerImage && (
          <img 
            src={bannerImage} 
        ...
        <div className="relative z-10">
          ...
          <button className="bg-white text-[#1C1C1C] font-['Inter'] font-medium text-[16px] py-[10px] px-[16px] rounded-[6px] shadow-[0px_1px_2px_0px_rgba(56,56,56,0.08)] border border-white hover:bg-gray-50 transition-all">
            Source now
          </button>
        </div>
      </div>
...
export default BlockItemsElectronics;